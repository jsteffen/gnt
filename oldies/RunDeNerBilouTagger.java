...
public class RunDeNerBilouTagger {
	public static void main(String[] args) throws IOException{
		...
		fileList.add(new Pair<String, String>(
				"resources/data/ner/bilou/deu-testa.conll", "resources/eval/deu-testa-bilou.txt"));
		fileList.add(new Pair<String, String>(
				"resources/data/ner/bilou/deu-testb.conll", "resources/eval/deu-testb-bilou.txt"));
