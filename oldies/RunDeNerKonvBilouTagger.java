...
public class RunDeNerKonvBilouTagger {
	public static void main(String[] args) throws IOException{
		...
		fileList.add(new Pair<String, String>(
				"resources/data/ner/bilou/deu.konvens.dev.conll", "resources/eval/deu-konv-dev-bilou.txt"));
		fileList.add(new Pair<String, String>(
				"resources/data/ner/bilou/deu.konvens.test.conll", "resources/eval/deu-konv-test-bilou.txt"));
