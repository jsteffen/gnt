...
public class WordShapeFeature {
  ...
  public void setBit(MorphFeature morphFeature) {
    ...
    switch (morphFeature) {
      case ALL_CAPS:
        this.bitVectorflip(0);
        break;
      case HAS_DASH:
        this.bitVectorflip(1);
        break;
      case HAS_DIGIT:
        this.bitVectorflip(2);
        break;
      case INIT_CAP:
        this.bitVectorflip(3);
        break;
      case KNOWNLC:
        this.bitVectorflip(4);
        break;
      case LOWER_CASE:
        this.bitVectorflip(5);
        break;
      case SUFF_AL:
        this.bitVectorflip(6);
        break;
      case SUFF_ED:
        this.bitVectorflip(7);
        break;
      case SUFF_ER:
        this.bitVectorflip(8);
        break;
      case SUFF_EST:
        this.bitVectorflip(9);
        break;
      case SUFF_ING:
        this.bitVectorflip(10);
        break;
      case SUFF_ION:
        this.bitVectorflip(11);
        break;
      case SUFF_ITY:
        this.bitVectorflip(12);
        break;
      case SUFF_LY:
        this.bitVectorflip(13);
        break;
      case SUFF_S:
        this.bitVectorflip(14);
        break;
      case SUFF_Y:
        this.bitVectorflip(15);
        break;
      default:
        break;
    }
