...
public class Corpus {
	...
	private void setLabeledData(){
		...
		trainingLabeledData.add("resources/data/english/english-train");
		...
		devLabeledData.add("resources/data/english/english-devel");
		...
		testLabeledData.add("resources/data/MLDP/english/english-test");
	}

	private void setUnLabeledData(){
		// It is assumed that these filenames are complete
		trainingUnLabeledData.add("resources/data/english/english-train-sents.txt");
