...
public class RunDeNerTagger {
	public static void main(String[] args) throws IOException{
		...
		fileList.add(new Pair<String, String>(
				"resources/data/ner/de/deu-testa.conll", "resources/eval/deu-testa.txt"));
		fileList.add(new Pair<String, String>(
				"resources/data/ner/de/deu-testb.conll", "resources/eval/deu-testb.txt"));
