...
public class RunEnNerBilouTagger {
	public static void main(String[] args) throws IOException{
		ModelInfo modelInfo = new ModelInfo("MDP");
		modelInfo.setTaggerName("NERBILOU");
		...
		fileList.add(new Pair<String, String>(
				"resources/data/ner/bilou/eng-testa.conll", "resources/eval/eng-testa-bilou.txt"));
		fileList.add(new Pair<String, String>(
				"resources/data/ner/bilou/eng-testb.conll", "resources/eval/eng-testb-bilou.txt"));
